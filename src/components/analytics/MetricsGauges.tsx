...
const GAUGE_CONFIG = {
  requests: { maxValue: 500, color: '#FFBF00', unit: '/min', targetValue: 400 },
  responseTime: { maxValue: 200, color: '#FF8C00', unit: 'ms', targetValue: 150 },
  ...
  diskUsage: { maxValue: 100, color: '#FF9500', unit: '%', targetValue: 75 },
};
